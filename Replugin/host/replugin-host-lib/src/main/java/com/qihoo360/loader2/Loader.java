    ...
    final boolean loadDex(ClassLoader parent, int load) {
        try {
            ...
            if (mPackageInfo == null) {
                Log.d("gaowei", "load mPackageInfo");
                // 通过系统api获取
...
//                }
            ...
            if (mPkgResources == null) {
                Log.d("gaowei", "load mPkgResources");
                // Resources
                try {
            ...
            if (mClassLoader == null) {
                Log.d("gaowei", "load mClassLoader");
                // ClassLoader
