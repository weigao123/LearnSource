...
import static com.qihoo360.replugin.RePlugin.install;
            ...
            public void onClick(View v) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        PluginInfo info = RePlugin.install(new File(Environment.getExternalStorageDirectory(), "app-debug.apk").getPath());
                        RePlugin.startActivity(MainActivity.this, RePlugin.createIntent("com.qihoo360.replugin.sample.demo1", "com.qihoo360.replugin.sample.demo1.MainActivity"));
